//
// Created by tmlishuai2 on 1/26/18.
//
//relative header
...
//3rd party lib header
#include <boost/timer.hpp>
#include <opencv2/highgui/highgui.hpp>
#include <opencv2/imgproc/imgproc.hpp>
#include <opencv2/calib3d/calib3d.hpp>

//header in own project
...
bool VisualOdometry::checkEstimatedPose() {
  if(num_inliers_ < min_inliers_) {
    cout << "reject because number of inliers is too small: " << num_inliers_ << endl;
    return false;
  }
  // if motion is too large, maybe wrong
